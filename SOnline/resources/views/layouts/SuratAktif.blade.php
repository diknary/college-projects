						...
						<div class="panel-footer">
							...
							<form class="form-horizontal">
								<div class="form-group">
									<label class="control-label col-sm-2" for="inputEmail">Nama Lengkap:</label>
									<div class="col-sm-9">
										<input type="email" class="form-control" id="inputNama" placeholder="Masukan Nama Lengkap">
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-2" for="inputPassword">NIM:</label>
									<div class="col-sm-9">
										<input type="password" class="form-control" id="inputNIM" placeholder="Masukan NIM">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label class="control-label col-sm-2" for="telp">Keperluan:</label>
									<div class="col-sm-9">
										<input type="tel" class="form-control" id="Keperluan" placeholder="Masukan Keperluan">
									</div>
								</div>
								<div class="form-group">
