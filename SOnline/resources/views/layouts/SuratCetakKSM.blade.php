				...
				<div class="col-sm-8"> 
					<div class="panel panel-default">
						...
						<div class="panel-footer">
							...
							<form class="form-horizontal" method="POST" action="{{ url('/form/submit') }}"  enctype="multipart/form-data">
								{!! csrf_field() !!}
								...
								<div class="form-group">
									<label class="control-label col-sm-2" for="inputKeperluan">Upload Form:</label>
									<div class="col-sm-9">
