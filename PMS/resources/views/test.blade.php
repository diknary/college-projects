...
@section('main-content')
  <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="row">
              <div class="col-sm-5">
              <div class="dataTables_info" id="example1_info" role="status" aria-live="polite">Showing 1 to 2 of 2 entries (filtered from 57 total entries)</div></div>
